...
import IMilestoneProps, { IMilestoneState } from "./Interfaces/IMiletone";
...
export default class MilestoneManagement extends React.Component<IMilestoneProps, IMilestoneState> {
  ...
  public componentWillReceiveProps(newProps: IMilestoneProps): void {
  ...
  public createColumns(): void {
    ...
    this.columns= [
      ...
      },
      {
        ...
        width: 100,
        events: {
          onClick: (ev: React.SyntheticEvent<any>, args: { rowIdx: number, idx: number, name: string }) => {
